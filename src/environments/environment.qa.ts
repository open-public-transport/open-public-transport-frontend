export const environment = {
  ...
  dashboard: {
    cities: [
      ...
      {name: 'Bochum', boundingBox: [7.102082282000026, 51.41051770900003, 7.349335097000051, 51.531372340000075], publicTransportTypes: []},
      {name: 'Bonn', boundingBox: [7.022537442000043, 50.63268994200007, 7.210679743000071, 50.77437020800005], publicTransportTypes: []},
      {name: 'Bremen', boundingBox: [8.481735118728654, 53.01102137832358, 8.990780355986436, 53.60761767768827], publicTransportTypes: []},
      ...
      {name: 'Dortmund', boundingBox: [7.303593755474529, 51.416072806289165, 7.637115868651861, 51.59952017917111], publicTransportTypes: []},
      {name: 'Dresden', boundingBox: [13.579721093821485, 50.9752258280855, 13.965849226642415, 51.176915429975296], publicTransportTypes: []},
      {name: 'Duesseldorf', boundingBox: [6.68881312000002, 51.124375875000055, 6.939933901000074, 51.352486457000055], publicTransportTypes: []},
      {name: 'Duisburg', boundingBox: [6.625616443645652, 51.333198590659165, 6.83045999817622, 51.560220016593334], publicTransportTypes: []},
      {name: 'Frankfurt-Main', boundingBox: [8.47276067000007, 50.01524884200006, 8.800381926000057, 50.22712951500006], publicTransportTypes: []},
      ...
      {name: 'Hamm', boundingBox: [7.675536280292723, 51.57805231922079, 7.997528913639968, 51.744766475157476], publicTransportTypes: []},
      ...
      {name: 'Leipzig', boundingBox: [12.236881307029405, 51.238535279757826, 12.542606999586994, 51.448066882712645], publicTransportTypes: []},
      {name: 'Muenchen', boundingBox: [11.36087720838895, 48.06223277978042, 11.723082533270206, 48.24814577602209], publicTransportTypes: []},
      {name: 'Muenster', boundingBox: [7.473962942770497, 51.840191151329854, 7.774221787742102, 52.060175509627584], publicTransportTypes: []},
      ...
      {name: 'Wuppertal', boundingBox: [7.01407471400006, 51.165736174000074, 7.313426359000061, 51.31809703300007], publicTransportTypes: []},
    ]
  },
  feature: {
    dashboard: true,
